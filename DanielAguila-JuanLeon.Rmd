...
las muestras con un gráfico. ¿Converge al valor teórico?
Muestre como converge la probabilidad de obtener una mano inicial (5 cartas) con 5 monstruos. Muestre
en el gráfico el valor teórico de esta situación. ¿Es correcta la convergencia mostrada en el gráfico?
```{r}
#Pregunta 1.2.1
library(ggplot2)
...
¿Cual es la probabilidad de que un disparo caiga de en el blanco (circulo centrado en 0,0 con radio 1[cm]) dado que el disparo fue hecho por el jugador con el rifle? 

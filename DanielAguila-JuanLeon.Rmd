...
Si consideramos la clara desventaja en ataque y vida del contrincante es resaltable que:

1.  Con ambas habilidades Phantom pueda llegar a ganar practicamente 30% de las batallas.
  
2.  Coup Grace por si sola no es para nada efectiva, tiene lógica si el ataque del oponente supera con creces al nuestro, pues hay baja probabilidad de usar la habilidad. 
